...
| switch reference | `reports/08-clause-02-switch-reference.md`; `reports/08-clause-01-subordination.md`; `reports/08-clause-03-relatives.md`; `lit-reviews/08-clause-03-subordination-lit.md`; switch-reference packet surfaces | R: yes, L: yes, M: no, A: no | same-subject and different-subject clause-linkage packet | yes | narrow slice | different-subject evidence remains limited; relative clauses now have a dedicated first-slice packet | hold stable at current first-slice maturity |
| relative clauses | `reports/08-clause-03-relatives.md`; subordination lit review | R: yes, L: yes, M: no, A: no | relative-clause packet | yes (`mi`-headed and nominalized relative-like constructions) | narrow slice | head-role and nominalization overlap still need reviewer confirmation | hold stable and review |
