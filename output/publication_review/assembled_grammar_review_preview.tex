...
This section summarizes the current evidence for noun-phrase order and
possession.
...
\tdim{Ni li} and \tdim{kum sawm le nih} both keep the noun before the
numeral, even when the numeral itself is compound. At the same time,
\tdim{mi khat} remains an explicit boundary row, since the present
section uses it as NP-order evidence without resolving the full numeral
versus indefinite analysis that belongs to the numerals and
quantifier-adjacent discussion.
...
This section gathers the current grammar-facing evidence for basic
noun-domain patterns.
...
\tdim{Ni li} and \tdim{kum sawm le nih} are the clearest counted anchors
for this purpose. Together they show that lexical noun heads remain
visible inside larger numeral phrases. The noun-domain claim is
therefore limited to lexical headedness; it does not reopen the fuller
NP-order or numeral/quantifier analyses.
...
This section summarizes the current evidence for NP-final case-like
marking.
...
clause-level agentive or ergative \tdim{-in} \glossquote{ergative}. The
same section also supports more cautious discussion of source marking
with \tdim{-pan} \glossquote{source} and \tdim{-panin}
...
These rows keep the oblique material concrete. \tdim{Inn panin} shows
source marking without a relator host, while \tdim{kei tawh} and
\tdim{leivui tawh} show that \tdim{-tawh} covers both accompaniment and
material-extension uses.
...
This section gathers the current grammar-facing evidence for the numeral
system.
