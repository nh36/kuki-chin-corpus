...
GLOSSARY_REQUIREMENTS: dict[str, tuple[tuple[str, ...], str]] = {
    ...
    "le": ((r"and \(NP coordinator\)|NP coordinator|and",), "and (NP coordinator)"),
    "vantung le leitung": ((r"heaven and earth",), "heaven and earth"),
    "leh": ((r"if / when|conditional",), "if / when"),
    "a piangsak": ((r"3SG/FUNC \+ create|agreement/function|false-friend",), "3SG/FUNC + create"),
    "mawh": ((r"deferred disjunction material|disjunction material|deferred",), "deferred disjunction material"),
    "Ahih hangin": ((r"but / however|adversative",), "but / however"),
    "ahih kei leh": ((r"otherwise / if not|if not|otherwise",), "otherwise / if not"),
    "mahmah": ((r"very, truly|EMPH~EMPH|intensifier",), "very, truly"),
    "taktak": ((r"truly, certainly|TRUE~TRUE|really",), "truly, certainly"),
    "peuhpeuh": ((r"each|distributive",), "every, each"),
    "pha mahmah hi": ((r"good very DECL|very good",), "good very DECL"),
    ...
    "pailai": ((r"go-midst|prospective form|prospective",), "go-midst / prospective form"),
    ...
    "kong": ((r"1→2|direct-like|from 1st to 2nd",), "1→2 / direct-like"),
    "hongbia": ((r"worship me|worship|2→1",), "worship me / worship"),
    "kongpia": ((r"give to you|give|1→2",), "give to you / give"),
    "kongkoih": ((r"place you|1→2|over all the land",), "place you / place over"),
    ...
    "kanei": ((r"I have|1SG-have",), "I have"),
    "ka-nei": ((r"1SG-have|I have",), "1SG-have"),
    "kainn": ((r"my house|1SG.POSS-house",), "my house"),
    "ka-inn": ((r"1SG.POSS-house|my house",), "1SG.POSS-house"),
    "ka-": ((r"first-person prefix|1SG prefix|first-person singular possessive|1SG\.POSS",), "first-person prefix"),
    "na-": ((r"second-person singular possessive|2SG possessive|2SG.POSS",), "second-person singular possessive"),
    "i-": ((r"first-person plural possessive|1PL possessive|1PL.POSS",), "first-person plural possessive"),
    "kei": ((r"I / me|I|me",), "I / me"),
    "nang": ((r"you(?:\.SG)?|you singular",), "you.SG"),
    "amah": ((r"he / she / it|he|she|it",), "he / she / it"),
    "eite": ((r"we|inclusive",), "we"),
    "kote": ((r"we(?:\.EXCL)?|exclusive",), "we.EXCL"),
    "note": ((r"you\.PL|you plural",), "you.PL"),
    "amaute": ((r"they|3PL",), "they"),
    "keimah": ((r"I myself|1SG\.EMPH|myself",), "I myself"),
    "nangmah": ((r"you yourself|2SG\.EMPH|yourself",), "you yourself"),
    "ki-gawm": ((r"join together|reciprocal",), "join together"),
    "ainn": ((r"his/her house|3SG.POSS-house",), "his/her house"),
    "ipai": ((r"we go|inclusive go|1PL.INCL-go",), "we go / inclusive go"),
    "hongmu": ((r"see me|come-see|3→1-see",), "see me / come-see"),
    "kongmu": ((r"I see you|1SG-see.2|1SG>3",), "I see you / 1SG-see.2"),
    "kipan": ((r"from|begin|reflexive",), "from / begin"),
