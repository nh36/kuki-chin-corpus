...
def main():
    ...
    parser.add_argument('--output', '-o', help='Output file (default: docs/grammar/reports/03-noun-04-relators.md)')
    ...
    if args.output:
        ...
        output_path = Path(__file__).parent.parent / 'docs' / 'paradigms' / '3-noun-04-relators.md'
