...
PROPER_NOUNS = {
    ...
    'geuel', 'gezer', 'giah', 'gibbar', 'gibbethon', 'gibea', 'gibeah', 'gibeon', 'giddalti', 'giddel',
    ...
    'siloah', 'siloam', 'silvanus', 'simeon-te', 'simon', 'simri', 'sin', 'sina', 'sinai', 'sinim',
    ...
    'garm', 'gebal', 'gebim', 'geharashim', 'gilo', 'ginnethoi', 'girzi', 'gishpa', 'gizon',
    'golgotha', 'gudgodah',
    ...
    'zethar', 'zia', 'ziba', 'zibeon', 'zibia', 'zibiah', 'zichri', 'ziddim', 'zidkijah', 'zidon',
    'zidonian', 'zif', 'ziha', 'ziklag', 'zikri', 'zillah', 'zillethai', 'zilpah', 'zilthai', 'zimmah',
    'zimran', 'zimri', 'zin', 'zina', 'ziph', 'ziphah', 'ziphim', 'ziphion', 'ziphite', 'ziphron',
...
def analyze_word(word: str) -> Tuple[str, str]:
    ...
    COMPOUND_WORDS = {
        ...
        # zap/zat- compounds
        'zaptelte': ('zap-tel-te', 'flutter-?-PL'),                  # (1x)
        'zaptelsak': ('zap-tel-sak', 'flutter-?-CAUS'),              # (1x)
        ...
        'namsau': ('nam-sau', 'sword-long'),                         # long sword (1x)
        ...
        'miksite': ('mik-si-te', 'eye-?-PL'),                        # (1x)
        # keh- compounds
        'kehsakkhak': ('keh-sak-khak', 'kick-CAUS-?'),               # (1x)
        # kam- compounds (kam = word)
        'kamsiam': ('kam-siam', 'word-skilled'),                     # skilled in words (1x)
        'kamsak': ('kam-sak', 'word-CAUS'),                          # (1x)
        'kamkeite': ('kam-kei-te', 'word-?-PL'),                     # (1x)
        # bah- compounds (bah = owe)
        'bahtoh': ('bah-toh', 'owe-up'),                             # (1x)
        # an- compounds
        'ansukna': ('an-suk-na', 'food-rest-NMLZ'),                  # (1x)
        # pat/vat- compounds
        'pattahsa': ('pat-tah-sa', 'touch-?-PERF'),                  # (1x)
        'vattansak': ('vat-tan-sak', 'hold-endure-CAUS'),            # (1x)
        # pam- compounds
        'pampamin': ('pam~pam-in', 'spread~RED-ERG'),                # (reduplication)
        # tui- compounds
        'tuihtuihin': ('tuih~tuih-in', 'hang~RED-ERG'),              # (reduplication)
        # pua- compounds
        ...
        'sialomtangte': ('sia-lom-tang-te', 'evil-want-?-PL'),      # - "covetousness"
