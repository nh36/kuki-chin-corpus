...
|--------|--------|-------------|
| `generate_paradigm.py` | `docs/paradigms/3-noun-01-simple.md` etc | Noun paradigm tables |
| `generate_relator_report.py` | `docs/paradigms/3-noun-04-relators.md` | Relator nouns |
| `generate_postposition_report.py` | `docs/paradigms/3-noun-05-postpositions.md` | Free postpositions |
| `generate_np_report.py` | `docs/paradigms/3-noun-06-np-structure.md` | NP structure patterns |

### Verb Reports

| Script | Output | Description |
|--------|--------|-------------|
| `generate_verb_stems_report.py` | `docs/paradigms/5-verb-01-stems.md` | Verb stem inventory |
| `generate_vp_report.py` | `docs/paradigms/5-verb-02-vp-structure.md` | VP template |
| `generate_pronominal_report.py` | `docs/paradigms/5-verb-03-agreement.md` | Agreement prefixes |
| `generate_tam_report.py` | `docs/paradigms/5-verb-04-tam.md` | TAM suffixes |
| `generate_vp_slots_report.py` | `docs/paradigms/5-verb-05-*.md` | Aspect/Dir/Modal/Deriv |
| `generate_valency_report.py` | `docs/paradigms/5-verb-09-valency.md` | Valency/voice |

### Other Reports

| Script | Output | Description |
|--------|--------|-------------|
| `generate_nominalization_report.py` | `docs/paradigms/7-nmlz-01-deverbal.md` | Nominalization |
