# Literature Review: Numerals in Tedim Chin

This report compiles previous scholarship on numeral systems in Tedim Chin.

---

## 1. Henderson (1965)

Henderson does not provide a dedicated section on numerals but uses numerals in her texts. The quantifier class is mentioned (p. 62) as a word class distinct from nouns.

---

## 2. Zam Ngaih Cing (2017/2018)

### 2.1 Numeral System (§3.3.3.5)

> "The base of Tedim Chin counting system is decimal, that is, the base form is 10 till the numeral 99. After 100, the base is 100."

### 2.2 Cardinals (§3.3.3.5.1)
...
Formed by **total reduplication** of cardinals:
