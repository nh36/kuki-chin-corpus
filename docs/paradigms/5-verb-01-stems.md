...
Total verb stems in lexicon: **689**

## Overview

Tedim Chin verbs are characterized by:

1. **Stem alternation** (Form I / Form II)
   - Form I: Indicative, used in conclusive sentences
   - Form II: Subjunctive, used in subordinate/inconclusive clauses
   - Changes: add -h/-k, tone change, -ng → -n

2. **Pronominal prefixes** for subject agreement
   - ka- (1SG), na- (2SG), a- (3SG), i- (1PL.INCL)

3. **TAM suffixes** for tense-aspect-mood
   - -ding (IRR), -ta (PFV), -zo (COMPL), -kik (ITER)
...
## Form I / Form II Alternation

Many verbs have two stems that alternate based on clause type:
...
| Stem | Gloss | Attestations | First Citation |
|------|-------|--------------|----------------|
| kibang | be.alike | 729x | Genesis 3:22 |
| kipan | begin | 629x | Genesis 4:26 |
| kibawl | be.done | 396x | Genesis 16:5 |
| kisai | concern | 295x | Genesis 12:20 |
| kilem | prepare | 176x | Exodus 29:33 |
| kipat | begin | 148x | Genesis 1:1 |
| kikhen | separate | 112x | Genesis 1:6 |
| kisik | repent | 108x | Genesis 6:3 |
| kizom | unite | 79x | Genesis 48:16 |
| kituah | meet | 42x | Genesis 32:19 |
| kikhia | depart | 21x | Genesis 43:12 |
| kikhel | differ | 12x | 1 Kings 5:14 |
...
## Complete Verb Stem List (Alphabetical)
...
| dek | low | other | 74x |
| dem | blame | other | 30x |
| denkhap | dash.in.pieces | other | 3x |
| diah | dip | other | 21x |
| diak | be.different | other | 35x |
| dial | call | other | 52x |
| dimdiam | socket | other | 11x |
| din | stand | other | 60x |
...
| dongun | boundary | other | 15x |
| dot | ask | other | 154x |
| dotnop | prosper | other | 2x |
| dua | quiet | other | 4x |
...
| gamsimtham | confusion | other | 2x |
| gamta | send.away | other | 722x |
| gamtat | kingdom | other | 972x |
| gap | look.at.each.other | other | 1x |
| gawm | seize | other | 14x |
| geel | plan | other | 75x |
| geelsa | mark | other | 12x |
| gelh | write | physical | 233x |
| gen | speak | speech | 3637x |
| giau | wait.upon | other | 2x |
| gilvah | be.satisfied | other | 16x |
| gimneih | fear | other | 2x |
| gimthuak | suffer | other | 23x |
| goih | visit | other | 2x |
| gopa | slay | other | 2x |
| guahciin | continual.drip | other | 2x |
| guaih | reward | other | 3x |
| guakbek | desolate | other | 2x |
| guang | carry | other | 18x |
| guta | destroyer | other | 40x |
| haihuaipi | vanity | other | 2x |
| hailawh | be.mad | other | 2x |
| haipau | vile | other | 3x |
| hal | burn | other | 265x |
| haltui | dross | other | 3x |
| hamtang | be.strong | other | 15x |
| hanciam | wrestle | other | 131x |
| hanga | offer | other | 170x |
...
| hehpih | be.angry | social | 411x |
| hehsuah | provoke.jealousy | other | 2x |
| hem | remove | other | 33x |
| hen | tie | other | 730x |
...
| hut | neigh | other | 28x |
| im | hide | other | 61x |
| innsia | desolate | other | 2x |
| iplah | take | other | 5x |
| isan | own | other | 0x |
| it | love | social | 760x |
| kalh | lock | other | 23x |
| kamguh | speak.rashly | other | 2x |
| kangsak | raise.up | causative | 14x |
| kanna | grey.hair | other | 2x |
| kantan | cross.over | other | 96x |
| kap | weep | physical | 282x |
| kauhkauh | tears | other | 2x |
| kawikawi | to.and.fro | other | 145x |
| kawma | chew | other | 11x |
| keek | tear | other | 37x |
| keenhawm | cave | other | 3x |
| kem | guard | other | 191x |
...
| kheguak | barefoot | other | 3x |
| khelkhiatsak | put.out.eyes | causative | 2x |
| khem | restrain | other | 5948x |
| khen | divide | other | 527x |
...
| khuisatna | groaning | other | 6x |
| khum | cover | other | 97x |
| khup | pit | other | 9x |
| khupin | stretch | other | 2x |
| khuto | pillar | other | 2x |
| kia | fall | reflexive | 5148x |
| kiallai | be.satisfied | reflexive | 2x |
| kibang | be.alike | reflexive | 729x |
...
| kikhawl | walk.with | reflexive | 53x |
| kikhawlpa | companion | reflexive | 4x |
...
| kimkotteng | brightness | reflexive | 2x |
| kinengniamte | oppressed | reflexive | 2x |
| kinetniam | relieve | reflexive | 2x |
| kipan | begin | reflexive | 629x |
| kipat | begin | reflexive | 148x |
| kiphamat | meet | reflexive | 2x |
| kiphatna | praise | reflexive | 7x |
| kiphawkmawh | pass.over | reflexive | 2x |
| kipuaseh | cut | reflexive | 6x |
| kisai | concern | reflexive | 295x |
| kisapna | need | reflexive | 35x |
| kisatnim | bruised | reflexive | 2x |
| kisik | repent | reflexive | 108x |
| kisil | wash | reflexive | 46x |
| kisuai | pomegranate | reflexive | 2x |
| kisut | spoil | reflexive | 13x |
| kitamzan | broken | reflexive | 11x |
| kitawng | strive | reflexive | 21x |
| kithawithawi | be.raised | reflexive | 2x |
| kithukhat | rage | reflexive | 3x |
| kituah | meet | reflexive | 42x |
| kizom | unite | reflexive | 79x |
| koih | put | transfer | 789x |
| koizaw | stand | other | 2x |
| kolbulh | stocks | other | 3x |
| kopkopin | chariot | other | 2x |
| kosiat | revile | other | 2x |
| kuaihtansak | break | causative | 12x |
| kuaitan | break | other | 23x |
| kuampi | valley | other | 4x |
| kultaltui | pitch | other | 2x |
| kunh | entreat | other | 9x |
| kunsuk | bend.down | other | 13x |
| kut | press | other | 6x |
...
| leikeu | dry.land | other | 2x |
| lek | appear | other | 5x |
| lela | rejoice | other | 2x |
| lencip | hold | other | 15x |
| lengsawn | hearing | other | 2x |
| let | return | motion | 168x |
| liahpai | return | motion | 0x |
| liang | shine | other | 69x |
| lianlua | too.much | other | 10x |
| likto | lift.up | other | 2x |
| limbawl | prepare | creation | 35x |
| limci | promise | other | 41x |
| lip | scale | other | 22x |
| lit | pine.away | other | 68x |
...
| maikhingsak | shame | causative | 2x |
| maiphut | confront | other | 2x |
| maiput | countenance | other | 2x |
| maitaisak | make.cheerful | causative | 2x |
| maizumlawh | confounded | other | 2x |
| mal | be.dry | other | 62x |
| manawh | direct.toward | other | 54x |
| mangkhin | faint | other | 15x |
| mangngilh | forget | other | 121x |
| manphazaw | succeed | other | 12x |
| mat | grasp | other | 457x |
| maw | see | other | 308x |
| mawh | guilty | other | 1254x |
| meeng | branch | other | 12x |
| meihal | burnt.offering | other | 306x |
| meiipi | leprous | other | 42x |
| meiizun | night.dew | other | 2x |
| meikhuka | hearth | other | 11x |
| meikuang | flaming | other | 112x |
| meipi | fire | other | 1x |
| meng | quick | other | 4x |
| mengmeng | quickly | other | 11x |
| mettom | utmost.corner | other | 2x |
| mibum | sorcerer | other | 3x |
| migit | mercy | other | 27x |
| mindai | shame | other | 75x |
| minthan | bless | other | 358x |
...
| ngongtat | oppose | other | 37x |
| ngtanpih | excellency | other | 0x |
| nial | argue | other | 178x |
| niamsak | bow | causative | 10x |
| niamsuk | let.down | other | 1x |
| nikten | dust | other | 3x |
| nipsak | settle | causative | 2x |
| nit | defile | other | 382x |
| nitsak | defile | causative | 9x |
| nkhiat | set.forward | other | 0x |
...
| patpuan | weave | other | 2x |
| pau | speak | speech | 728x |
| paupai | gossip | other | 0x |
| pawlthei | join | other | 0x |
| peel | peel | other | 14x |
| pekpak | swoon | other | 2x |
...
| phitsan | hiss | other | 3x |
| phong | reveal | other | 22x |
| phulet | pass | other | 2x |
...
| suamlum | murder | other | 2x |
| suan | plant | other | 1529x |
| suangmai | smooth.stone | other | 3x |
| suanna | expectation | other | 2x |
| sumngo | rotten | other | 155x |
| sunglam | inside.way | other | 17x |
| sungtawng | within | other | 10x |
| sunletzo | bridle | other | 2x |
| sunlum | reach | other | 2x |
...
| taleng | gather | other | 13x |
| tama | repair | other | 35x |
...
| tawi | carry | other | 234x |
| tawizawh | spider | other | 2x |
| tawk | be.drunk | other | 3x |
| tawlngak | rest | other | 62x |
| tawng | contend | other | 30x |
| tawp | end | other | 134x |
| teel | choose | other | 260x |
| teeptum | drive.away | other | 2x |
| teh | measure | other | 173x |
| ten | dwell | other | 292x |
| teng | dwell | existence | 1077x |
| tenkhak | dwell | other | 2x |
| thadah | forgive | other | 32x |
| thak | new | other | 298x |
| thakbawl | rejoice | other | 2x |
| thakhatthu | suddenly | other | 11x |
| thalpaih | cast.down | other | 2x |
| thalpeu | bend | other | 2x |
| thalsing | myrrh | other | 3x |
| thaltawi | archer | other | 7x |
...
| theu | cease | other | 2x |
| thop | oppress | other | 6x |
| thuahkhawm | gather | other | 2x |
| thuak | suffer | other | 871x |
| thugen | preach | speech | 753x |
| thukihilh | reproof | other | 3x |
| thukpi | flood | other | 33x |
| thuksak | plead | causative | 6x |
| thunem | restore | other | 3x |
| thupalsat | transgressor | other | 14x |
...
| tuh | sow | other | 126x |
| tuibuak | water | other | 2x |
| tuikhu | fountain | other | 85x |
| tuikhukpi | pool | other | 2x |
| tuithuk | deep | other | 13x |
| tukhang | this.generation | other | 2x |
...
| viau | be.fragrant | other | 1x |
| vokcing | swineherd | other | 4x |
| vot | vote | other | 16x |
| vuau | pour.forth | other | 1x |
...
| zem | be.straight | other | 21x |
| zenzen | at.all | other | 53x |
| ziauziau | go.about | other | 2x |
| zik | wife | other | 31x |
| zineih | wed | other | 3x |
| zingsol | morning.star | other | 4x |
| zinkhia | wander | other | 2x |
| zinleleeng | temperate | other | 2x |
| zol | redeem | social | 59x |
| zomlai | journey | other | 12x |
| zongpa | wisdom | other | 4x |
| zop | join | other | 7x |
| zuahzuah | little.by.little | other | 2x |
| zualsakin | gradually | other | 2x |
| zuan | cross | motion | 91x |
| zuat | prepare | other | 26x |
...
*Generated from Tedim Chin Bible corpus analysis*