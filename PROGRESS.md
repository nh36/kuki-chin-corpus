...
- The quantifiers dossier now exists, but the grammar, dictionary, and review-note slices have not yet begun; coordinators and sentence-final particles remain later narrow candidates, while broad TAM, directionals, chrestomathy, Mizo/lus, and other Kuki-Chin language work remain deferred.
...
1. [ ] Continue the quantifiers retrofit from `dossier_quantifiers.md` into `grammar_quantifiers_print_slice.md` without broadening into coordinators, sentence-final particles, or broad degree/intensifier prose.
