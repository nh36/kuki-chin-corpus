...
- A report-to-grammar coverage reconciliation now exists at `output/publication_review/report_to_grammar_coverage_reconciliation.md`, and it selects the next substantive coverage target as a dedicated `ki-` reflexive/reciprocal/middle packet (not started in this commit).
...
- The relative-clause / relative-like nominal-modifier packet has now been started and lifted to a first grammar-facing print slice.
...
8. [ ] Keep chrestomathy, Mizo/lus, and the other Kuki-Chin languages deferred until they are explicitly chosen as a new scope.
