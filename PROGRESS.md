...
- Negation is now closed for this stage unless a concrete factual problem appears.
- The demonstratives/deixis dossier at `output/publication_review/dossier_demonstratives.md` remains the active next narrow Tedim topic.
...
- Demonstratives/deixis is the pilot topic for the new candidate-extraction layer in `output/publication_review/candidates_demonstratives.tsv`.
...
1. [ ] Use analyzer-aware candidate files before drafting any future Tedim publication-review grammar or dictionary slice, beginning with demonstratives/deixis.
