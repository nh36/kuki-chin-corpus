...
- The next substantive missing first-band domain is now clause linkage: subordination / switch reference / relative clauses, because the whole-grammar audit still treats those as report-backed but unlifted and they remain a major architecture gap before any full grammar print bundle.
